...
Сам алгоритм вкртаце - алгоритм DAG

У нас есть список исходящих ребер, из каждой непосещенной вершины запускаем dfs и держим два множества

visited - для обработанных вершин

recursionStack - для вершин, которые сейчас в процессе

Если во время dfs мы нашли вершину из recursionStack, то это значит, что мы зациклились

Так мы проходим по непосещенным вершинам, если ни в какой момент проблема не возникла, то цикла нет
